...
public class DownloaderTaskFragment extends Fragment {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        ArrayList<Integer> friendsId = (ArrayList<Integer>) this.getArguments().get(MainActivity.TAG_FRIEND_RES_IDS);
        Integer[] arrayFriends = friendsId.toArray(new Integer[0]);

        //  Start the DownloaderTask

        downloaderTask.execute(arrayFriends);
